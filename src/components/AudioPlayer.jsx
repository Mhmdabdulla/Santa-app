...
const BackgroundMusic = ({ playbackRate = 1.0 }) => {
    ...
    return (
        <div className="fixed bottom-4 right-4 z-50">
            ...
            <button
                onClick={togglePlay}
                className={`w-12 h-12 rounded-full flex items-center justify-center text-white shadow-lg transition-all duration-300 hover:scale-110 border border-white/20 backdrop-blur-md ${isPlaying
                    ? 'bg-white/10 text-festive-gold shadow-[0_0_15px_rgba(255,215,0,0.3)] animate-pulse-slow'
